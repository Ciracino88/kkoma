...
export function UploadDropzone({ onOpen }: { onOpen: () => void }) {
  return (
    <div
      onClick={onOpen}
      className="bg-card border-2 border-dashed border-border hover:border-primary/40 hover:bg-primary/[0.02] transition-all cursor-pointer p-8 mb-6 rounded-2xl flex items-center justify-center gap-4 group"
    >
